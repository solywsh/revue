...
func getOld() string {
	activities := []map[string]string{
		...
		{"name": "使用\\t", "good": "你看起来更有品位", "bad": "别人会觉得你在装逼"},
		...
		{"name": "写超过35行的方法", "good": "你的代码组织的很好，长一点没关系", "bad": "你的代码将混乱不堪，你自己都看不懂"},
		...
		{"name": "打雀魂", "good": "你的天胡概率从30万分之一涨到了29万分之一", "bad": "做大牌被断幺九带走"},
		...
		{"name": "刷圣遗物", "good": "圣遗物全是双暴", "bad": "圣遗物全是+生命30%"},
		{"name": "小A两把", "good": "你将双锤骷髅海", "bad": "你将成为最称职的快递员"},
	}
	var good, bad string
	// 随机种子
	...
	for i := 0; i < 4; i++ {
		...
		activities = append(activities[:index], activities[index+1:]...) // 删除对应的选项
	}
	return "宜:\n" + good + "不宜:\n" + bad
}
